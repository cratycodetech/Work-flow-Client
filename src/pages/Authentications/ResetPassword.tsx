...
import resetPassAnimation from "../../assets/auth/resetPass.json"
            ...
            <div className="bg-[#F0F4FA]">
                ...
                <div className="w-full md:w-5/6 lg:w-5/12">
                    <div className="text-[#04080F] mb-5">
                        <h2 className="font-semibold text-xl leading-9 text-center">Password Reset</h2>
                        <p className="text-sm font-normal leading-5 text-center mt-1">Enter your new password.</p>
                    </div>
                ...
                <div className="">
                    <div className="w-full flex items-center justify-center lg:border-b lg:border-l lg:border-gray-300">
                      <Lottie className="lg:h-[500px] md:h-[400px] h-[300px]" animationData={resetPassAnimation} />
                    </div>
                </div>
            </div>
            </div>
